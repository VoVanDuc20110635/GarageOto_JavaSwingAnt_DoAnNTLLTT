...
public class Frame_ThemChiNhanh extends javax.swing.JFrame {
    ...
    public Frame_ThemChiNhanh(NhanVien nhanVien) {
        ...
        int soChiNhanh = 0;
        try {
            soChiNhanh = chiNhanhService.demSoChiNhanh();
        } catch (SQLException ex) {
            Logger.getLogger(Frame_ThemChiNhanh.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        btnXemChiNhanh_luu.setText("Thêm");
        ...
        tareXemChiNhanh_diaChi.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
...
//    int a = 0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_ThemChiNhanh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frame_ThemChiNhanh().setVisible(true);
            }
        });
    }
